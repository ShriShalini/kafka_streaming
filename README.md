...
3. Creating a topic with set partitions and replicas: docker exec -it kafka1 kafka-topics.sh \
                    --create \  
                    --topic test-topic \
                    --partitions 3 \              
...
4. Describing a topic: docker exec -it kafka_streaming-kafka-1 kafka-topics.sh  --bootstrap-server localhost:9092 --describe --topic test-topic
